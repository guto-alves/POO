	...
	private void initialize() {
		...
		tableView.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
			...
			if (newValue == null) {
				...
				streetTextField.setText(newValue.getAddress().getStreet());
				numberTextField.setText(String.valueOf(
						newValue.getAddress().getNumber()));
				complementTextField.setText(newValue.getAddress().getComplement());
				postalCodeTextField.setText(newValue.getAddress().getPostalCode());
