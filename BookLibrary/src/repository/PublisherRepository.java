...
public class PublisherRepository {
	...
	public int addPublisher(String name, String address, String phone) {
		try {
			insertNewPublisher.setString(1, name);
			insertNewPublisher.setString(2, address);
			insertNewPublisher.setString(3, phone);
